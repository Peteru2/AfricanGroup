...
const About = () => {
    return ( 
        ...
        <Navbar />
            <div className="about">
                <div className="h-[500px] md:pt-52 pt-32   pb-72 text-white  bg-public bg-opacity-70 ">
                    ...
                    className="items-center font-bold flex justify-center text-2xl">AfricanGroup <span className="h-2 w-2 mx-4 bg-white bg-opacity-60 rounded-full"></span> About Us</motion.h2>
                    <div className="mt-20 ">
     ...
     // Animation settings
                         ...
                         className="bg-white w-[550px] md:mx-6 my-4 p-10">
