        ...
        <>
            <section className=" bg-public bg-opacity-70 py-8 w-full md:px-0 px-6 flex justify-center text-white">
                <div className="">
                    ...
                    <button className="rounded-full font-roboto px-12 border-2 border-white flex py-2    hover:text-public hover:bg-white  transition ease-in-out  duration-300">Subscribe</button>
                    </div>
                </div>
