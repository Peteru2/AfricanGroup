           ...
           <div className="flex justify-center items-center">
            <section className="footer-child  grid md:grid-cols-2 gap-4 grid-cols-1 bg-vintage  py-8 px-8  md:mx-16 mx-6 flex  text-white ">
                <div className="">
                    ...
                    <h4 className="text-[16px] font-roboto break-words w-[500px]">Get the latest updates about the latest developments and exciting news on how we are shaping the future!</h4>
                </div>
                <div className="md:ml-auto  flex items-center"> 
                <div className="md:ml-auto md:w-auto w-full grid md:grid-cols-2 grid-cols-1 gap-2 ">
                    <input type="text" className="px-2" placeholder="Email"/>
