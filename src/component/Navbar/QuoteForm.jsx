    ...
    <>
      <section>
        <form
          onSubmit={sendEmail}
          ref={form}
          className={`font-roboto text-black ${success ? "hidden" : ""}`}
        >
          ...
          <div className="mb-6">
            <label className="my-2 mt-4 label flex">
              ...
              <span
                className={`ml-auto text-red text-[14px] ${
                  errors.fullname ? "blink-error" : ""
                }`}
              >
                {" "}
                {errors.fullname}
          ...
          <div className="mb-6">
            <label className="my-2 label flex">
              ...
              <span
                className={`ml-auto text-red text-[14px] ${
                  errors.phoneNumber ? "blink-error" : ""
                }`}
              >
                {" "}
                {errors.phoneNumber}
          ...
          <div className="mb-6">
            <label className="my-2 label flex">
              <span>
                Describe Your Project <span className="text-red">*</span>
              </span>{" "}
              <span
                className={`ml-auto text-red text-[14px] ${
                  errors.project ? "blink-error" : ""
                }`}
              >
                {" "}
                {errors.project}
          ...
          <button
            type="submit"
            className="bg-private hover:bg-private hover:bg-opacity-90  text-white font-semibold py-4 px-4 rounded w-full"
          >
            {icon ? (
              <span>
        ...
        <div className={`font-roboto text-black ${success ? "" : "hidden"}`}>
          ...
          <button
            className={`bg-private w-full border-[1px] text-white rounded-[4px]  mt-3 ${
              formMessage && formMessage.includes("Successfully")
                ? "text-green"
                : "hidden"
            }`}
          ...
          <button
            className={`border-gray border-[1px] rounded-[4px] w-[50px] ${
              formMessage && formMessage.includes("Error")
                ? "text-green"
                : "hidden"
            }`}
