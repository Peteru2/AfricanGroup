...
const BlogPost = ({ post }) => {
  ...
  return (
    <>
      <Helmett title={`Blog - ${post.title}`} />
      <div className="xl:mx-[90px] md:mx-5  mx-6 my-5 font-roboto">
        <h2 className="text-sm text-black text-opacity-50 flex items-center ">
          {" "}
          <span>by {post.author} </span>{" "}
          <span className="w-6 mx-2 flex h-[1px] bg-black bg-opacity-50"></span>
        ...
        <div className="my-3">
          ...
          <div className="flex items-center mt-6">
            <p className="text-gray text-[50px] mr-12">
              <i className="fa fa-quote-right"></i>
            </p>
            <p className="font-bold md:w-[850px] md:text-[40px] text-[33px]">
              {post.h2}
            </p>
          </div>
