              ...
              <div>
                <p className=" text-center  py-2 font-roboto text-black text-[16px] pb-10 break-all">
                  <i>
                    ...
                    Quia aliquam aspernatur quaerat ut maxime, porro quam ullam
                    error perspiciatis quasi omnis sequi doloremque eveniet
                    inventore obcaecati! Debitis possimus ut maiores fugiat
                    autem doloribus facilis explicabo labore voluptatibus,
                    quibusdam, provident pariatur.
                  </i>{" "}
                </p>
              </div>
            </Carousel>
