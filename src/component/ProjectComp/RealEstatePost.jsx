...
const RealEstatePost = () => {
  ...
  return (
    <>
      <Helmett title={`Real Estate - ${post.title}`} />
      <Layout>
        <ImageWithOverlay
          imageUrl={image}
          span1="Project"
        ...
        <div className="my-4 xl:mx-[90px] md:mx-5 mx-6 font-roboto">
          <div className="my-3">
            <div className="grid md:grid-cols-2 grid-cols-1 w-full">
              <div>
                <h2 className="text-black font-bold text-[18px] mb-4 text-opacity-80">
                  <i className="fa fa-map-marker"></i> {post.location}
                </h2>
                <h2 className="text-black font-normal text-opacity-60 flex items-center">
                  <span className="rounded font-thin text-sm py-1 bg-gray bg-opacity-20 test-gray px-3 mr-3">
                    Land
                  </span>
                  <span
                    className={`${
                      post.status == "Available"
                        ? "bg-private bg-opacity-20  text-private"
                        : post.status == "Sold Out"
                        ? "bg-red bg-opacity-20 font-thin text-red"
                        : ""
              ...
              <div className="md:ml-auto md:mt-0 mt-5">
                <h2 className="font-bold text-black text-opacity-80 text-[18px] mb-2">
                  <i>{post.price}</i>
                </h2>
                <h2 className="text-black font-normal text-opacity-60">
                  <i> per {post.sqm} sqm</i>
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="flex w-full mt-2">
            <div className="md:ml-auto md:my-0 my-4">
              <Link to={"/request-quote"}>
                <button className="p-2 py-3 border-[1px] border-gray shadow rounded-md ">
                  Book appointment
                </button>
              </Link>
              <Link to={"https://wa.me/2349017730877"}>
                <button className="bg-public rounded-md text-white p-2 py-3 ml-4">
                  Contact Us
                </button>
              </Link>
            </div>
          ...
          <div className="mt-8">
            <h2 className="font-bold text-[18px] my-2 ">Amenities</h2>
          ...
          <div className=" mt-8">
            <h2 className="font-bold text-[18px] my-2">Landmarks</h2>
            <div className="md:ml-10 ml-6">
              <ol className="list">
          ...
          <div className=" mt-8">
            <h2 className="font-bold text-[18px] my-2">Documents</h2>
            <div className="md:ml-10 ml-6">
              <ol className="list">
          ...
          <div className=" mt-8">
              ...
              <div className="my-2">
                {post.paymentPlan.map((plan, index) => (
                  <div key={index} className="my-3">
                    <h2 className="my-2 font-bold text-black text-opacity-80">
                      {plan.sqr} - ₦{plan.price} ({plan.paymentMethod})
                    </h2>

                    {plan.currentValue != "" && (
                      <h2 className="my-2  text-black text-opacity-80">
                        {" "}
            ...
            <div className="border-y-[1px] border-gray py-8 mt-6">
              ...
              <h2>
                <span className="font-bold text-[17px] text-black text-opacity-70">
                  Bank name:
                </span>{" "}
                <span className="text-opacity-80 text-black text-[17px]">
                  Access Bank
                </span>
              </h2>
              ...
              <div className="md:flex w-full ">
                <div>
                  <h2>
                    ...
                    <span className="text-opacity-80 text-black text-[17px]">
                      African Survey and Realty limited
                    </span>
                  </h2>
                  <h2>
                    <span className="font-bold text-[17px] text-black text-opacity-70">
                ...
                <button className="md:ml-auto md:mt-0 mt-3 ">
                  <Link
                    to={"https://wa.me/2349017730877"}
                    className="bg-private text-white p-4 rounded"
                  >
                    Pay now
                  </Link>
                </button>
