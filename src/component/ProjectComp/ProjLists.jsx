...
style={{ 'maxWidth': '100%', 'height': 'auto', position: 'relative' }}>
    ...
    <div className={` text-sm absolute right-[17px] py-[6px] px-4  bg-public bg-opacity-80 text-black rounded-[2px]  `}>
    <h2>Available</h2>
    </div>
    <div className="absolute inset-1 px-10 flex justify-center items-center]">
    ...
    <div className="text-white px-4 absolute bottom-4 left-4">
            ...
            <h2 className="text-sm flex items-center ">Real Estate <span className="w-[4px] h-[4px] mx-1 flex bg-white rounded-full "></span> Surveying <span className="w-[4px] h-[4px] mx-1 flex bg-white rounded-full"></span> Construction</h2>
        </div>
    </div>
</motion.div>
<motion.div
...
style={{ 'maxWidth': '100%', 'height': 'auto', position: 'relative' }}>
    ...
    <div className={` text-sm absolute right-[17px] py-[6px] px-4  bg-red bg-opacity-80 text-black rounded-[2px]  `}>
    <h2>Sold Out</h2>
    </div>
    <div className="absolute inset-1 px-10 flex justify-center items-center]">
...
style={{ 'maxWidth': '100%', 'height': 'auto', position: 'relative' }}>
    ...
    <div className={` text-sm absolute right-[17px] py-[6px] px-4  bg-yellow bg-opacity-80 text-black rounded-[2px]  `}>
    <h2>Ongoing</h2>
    </div>
    <div className="absolute inset-1 px-10 flex justify-center items-center]">
